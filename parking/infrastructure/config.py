...
class LoggerConfig(BaseSettings):
    ...
    format: Literal["json", "pretty"] = Field(default="pretty", description="Log format")
...
class SearchConfig(BaseSettings):
    ...
    earth_radius_meters: int = Field(default=6371000, description="Earth radius in meters for distance calculations")
