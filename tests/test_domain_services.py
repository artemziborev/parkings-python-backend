...
@pytest.fixture
def synchronization_service(mock_storage, mock_data_source):
    """Creates synchronization service with mocks."""
    return ParkingSynchronizationService(mock_storage, mock_data_source)


@pytest.fixture
def search_service(mock_storage):
    """Creates search service with mocks."""
    return ParkingSearchService(mock_storage)
...
class TestParkingSynchronizationService:
    """Tests for ParkingSynchronizationService."""

    @pytest.mark.asyncio
    async def test_synchronize_parking_data(
        self, synchronization_service, mock_storage, mock_data_source, sample_parking
    ):
        """Tests parking data synchronization."""
        # Setup
        mock_data_source.fetch_parking_data.return_value = [sample_parking]

        # Execute
        await synchronization_service.synchronize_parking_data()
...
class TestParkingSearchService:
    """Tests for ParkingSearchService."""

    @pytest.mark.asyncio
    async def test_search_by_coordinates(
        self, search_service, mock_storage, sample_parking
    ):
        ...
        # Execute
        result = await search_service.search_by_coordinates(coordinates, 1000, 5)
    ...
    @pytest.mark.asyncio
    async def test_search_by_id(self, search_service, mock_storage, sample_parking):
        """Tests parking search by ID."""
        # Setup
        mock_storage.find_by_id.return_value = sample_parking

        # Execute
        result = await search_service.search_by_id(1)
    ...
    @pytest.mark.asyncio
    async def test_search_by_id_not_found(self, search_service, mock_storage):
        """Tests search for non-existent parking."""
        # Setup
        mock_storage.find_by_id.return_value = None

        # Execute
        result = await search_service.search_by_id(999)
    ...
    @pytest.mark.asyncio
    async def test_search_by_name(self, search_service, mock_storage, sample_parking):
        """Tests parking search by name."""
        # Setup
        mock_storage.find_by_name.return_value = [sample_parking]

        # Execute
        result = await search_service.search_by_name("Test", 10)
    ...
    @pytest.mark.asyncio
    async def test_search_by_name_and_number(
        self, search_service, mock_storage, sample_parking
    ):
        ...
        # Execute
        result = await search_service.search_by_name_and_number("Test", "A001", 10)
    ...
    async def test_search_by_address(
        ...
        # Execute
        result = await search_service.search_by_address("Test St", 10)
    ...
    @pytest.mark.asyncio
    async def test_get_all_parkings(self, search_service, mock_storage, sample_parking):
        """Tests retrieval of all parkings."""
        # Setup
        mock_storage.find_all.return_value = [sample_parking]

        # Execute
        result = await search_service.get_all_parkings(limit=100)
    ...
    @pytest.mark.asyncio
    async def test_get_all_parkings_no_limit(
        self, search_service, mock_storage, sample_parking
    ):
        ...
        # Execute
        result = await search_service.get_all_parkings()
